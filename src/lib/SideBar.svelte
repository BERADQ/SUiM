<script lang="ts">
  ...
  export let onchange: (a_count: number) => {};
...
<style lang="postcss">
  .main {
    ...
    &::before {
      ...
      box-shadow: calc(0px - var(--sh-size)) calc(0px - var(--sh-size)) 0 var(--sh-size) transparent;
      transition: all var(--transition);
    }

    &.ov::before {
      box-shadow: calc(0px - var(--sh-size)) calc(0px - var(--sh-size)) 0 var(--sh-size) var(--bg-color0);
    }
  ...
  .box {
    ...
    &::after {
      ...
      --sh-size: calc(var(--radius-size) * 0.25);
      box-shadow: var(--sh-size) calc(0px - var(--sh-size)) 0 var(--sh-size) transparent;
    ...
    &.ac {
      ...
      &::before {
        box-shadow: var(--sh-size) var(--sh-size) 0 var(--sh-size) var(--bg-color1);
      }

      &::after {
        box-shadow: var(--sh-size) calc(0px - var(--sh-size)) 0 var(--sh-size) var(--bg-color1);
      }
